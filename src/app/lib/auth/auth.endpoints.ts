export class AuthEndpoints {
  ...
  public static readonly PARAM_SCOPE = "scope";
  public static readonly PARAM_REDIRECT_URI = "redirect_uri";
  public static readonly PARAM_CLIENT_SECRET = "client_secret";
  public static readonly PARAM_GRANT_TYPE = "grant_type";
